...
var (
	...
	cacheEasyChatGroupRequestsIdPrefix = "cache:easyChat:groupRequests:id:"
)
...
func (m *defaultGroupRequestsModel) Delete(ctx context.Context, id int64) error {
	groupRequestsIdKey := fmt.Sprintf("%s%v", cacheEasyChatGroupRequestsIdPrefix, id)
...
func (m *defaultGroupRequestsModel) Insert(ctx context.Context, data *GroupRequests) (sql.Result, error) {
	groupRequestsIdKey := fmt.Sprintf("%s%v", cacheEasyChatGroupRequestsIdPrefix, data.Id)
...
func (m *defaultGroupRequestsModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheEasyChatGroupRequestsIdPrefix, primary)
}
