...
var (
	...
	cacheEasyChatGroupMembersIdPrefix = "cache:easyChat:groupMembers:id:"
)
...
func (m *defaultGroupMembersModel) Delete(ctx context.Context, id int64) error {
	groupMembersIdKey := fmt.Sprintf("%s%v", cacheEasyChatGroupMembersIdPrefix, id)
...
func (m *defaultGroupMembersModel) Insert(ctx context.Context, session sqlx.Session, data *GroupMembers) (sql.Result, error) {
	groupMembersIdKey := fmt.Sprintf("%s%v", cacheEasyChatGroupMembersIdPrefix, data.Id)
...
func (m *defaultGroupMembersModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheEasyChatGroupMembersIdPrefix, primary)
}
