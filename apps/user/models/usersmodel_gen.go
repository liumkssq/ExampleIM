...
var (
	...
	cacheEasyChatUsersIdPrefix = "cache:easyChat:users:id:"
)
...
func (m *defaultUsersModel) FindByPhone(ctx context.Context, phone string) (*Users, error) {
	userIdKey := fmt.Sprintf("%s%v", cacheEasyChatUsersIdPrefix, phone)
	var resp Users
...
func (m *defaultUsersModel) Delete(ctx context.Context, id string) error {
	easyChatUsersIdKey := fmt.Sprintf("%s%v", cacheEasyChatUsersIdPrefix, id)
...
func (m *defaultUsersModel) FindOne(ctx context.Context, id string) (*Users, error) {
	easyChatUsersIdKey := fmt.Sprintf("%s%v", cacheEasyChatUsersIdPrefix, id)
	var resp Users
	err := m.QueryRowCtx(ctx, &resp, easyChatUsersIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUsersModel) Insert(ctx context.Context, data *Users) (sql.Result, error) {
	easyChatUsersIdKey := fmt.Sprintf("%s%v", cacheEasyChatUsersIdPrefix, data.Id)
...
func (m *defaultUsersModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheEasyChatUsersIdPrefix, primary)
}
